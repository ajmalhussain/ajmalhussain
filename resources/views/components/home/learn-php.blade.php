<x-call-to-action>
  <x-slot:title>
    ...
    <x-button-link href="https://youtube.com/ajmalhussain" variant="dark" class="mr-3" target="_blank">
      View my channel
    </x-button-link>
    <x-button-link href="https://www.youtube.com/watch?v=Eccg4YdmYJ8" variant="red" target="_blank">
      Watch on YouTube
    </x-button-link>
</x-call-to-action>
